...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary-500/10 rounded-full blur-[100px] -z-10" />
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="bg-card border border-border p-8 rounded-3xl shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-foreground/60 text-sm mt-2">Start sharing markdown notes securely</p>
          </div>
